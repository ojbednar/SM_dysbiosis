...
ggsave("bug_OR.png", fpp, width = 6, height = 5, dpi = 1200, device = "png")
...
ggsave("pd_death_enr_sma.png", autoplot(km_trt_fit), width = 6, height = 4, dpi = 1200, device = "png") 
#coma
...
surv_pvalue(km_trt_fit)
ggsave("pd_death_enr_cm.png", autoplot(km_trt_fit), width = 6, height = 4, dpi = 1200, device = "png") 
#acidotic
...
ggsave("pd_death_acidotic.png", autoplot(km_trt_fit), width = 6, height = 4, dpi = 1200, device = "png") 
#intestinal injury
...
ggsave("pd_death_tff3_inj.png", autoplot(km_trt_fit), width = 6, height = 4, dpi = 1200, device = "png") 
#uric_acid
...
ggsave("pd_death_hyper_uri.png", autoplot(km_trt_fit), width = 6, height = 4, dpi = 1200, device = "png") 
#lacidosis
...
ggsave("pd_death_lacidosis.png", autoplot(km_trt_fit), width = 6, height = 4, dpi = 1200, device = "png") 
#haki
...
ggsave("pd_death_haki.png", autoplot(km_trt_fit), width = 6, height = 4, dpi = 1200, device = "png") 
#sex
...
ggsave("pd_death_sex.png", autoplot(km_trt_fit), width = 6, height = 4, dpi = 1200, device = "png") 
#site
...
ggsave("pd_death_site.png", autoplot(km_trt_fit), width = 6, height = 4, dpi = 1200, device = "png") 
#Enterob
plot_data <- asv_sick %>%
  tax_fix() %>%
  tax_transform("compositional", rank = "Family") %>%
...
km_trt_fit <- survfit(Surv(days_to_living, sm_death12m) ~ high_enterob, data=death_df)
g1<-autoplot(km_trt_fit)
g2<- g1 + scale_fill_manual(values = c("darkgray","orange"))+scale_color_manual(values = c("darkgray","orange"))
surv_pvalue(km_trt_fit)
ggsave("pd_death_Enterob_median.png", g2, width = 6, height = 4, dpi = 1200, device = "png") 
